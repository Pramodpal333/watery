...
class DrinksList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 10,),
                        Text('$qty ${controller.drinkList.value[index].type}',style: const TextStyle(color: Colors.white,fontWeight: FontWeight.w400,fontSize: 18),),
                      ],
                    ),
                    Row(
                      children: [
                        Text('${controller.drinkList.value[index].time}',style: const TextStyle(color: Colors.white,fontWeight: FontWeight.w400,fontSize: 18),),
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            child: Container(
                              ...
                              margin: EdgeInsets.all(5),
                                ...
                                child:Center(child: Icon(Icons.edit,color: Colors.white,size: w*0.03,))),
                          ),
                        )
                      ],
                    ),
   ...
   Widget noList(){
    return Center(
        child: Text("Add Drinks",style: TextStyle(color: Colors.white),)
    );
   }
}
